...
public class ReflectionTestUtilsTest {
    ...
    void studentBeforeEach() {
        studentOne.setFirstname("Prince");
        studentOne.setLastname("Sharma");
        studentOne.setEmailAddress("prince.sharma@gmail.com");
    ...
    void invokePrivateMethod() {
        assertEquals("Prince 1", ReflectionTestUtils.invokeMethod(studentOne, "getFirstNameAndId"),"Fail private method not call");
    }
}
